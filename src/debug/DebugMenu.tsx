...
import { runBatchWarmCache } from './batchWarmCache';
import { runBatchStripHistory } from './batchStripHistory';
  ...
  useEffect(() => {
    ...
    listen<string>('menu-event', (event) => {
      ...
      switch (id) {
        ...
        case 'debug-batch-warm-cache':     void runBatchWarmCache(); break;
        case 'debug-batch-strip-history':  void runBatchStripHistory(); break;
      }
    }).then((fn) => { unlisten = fn; });
