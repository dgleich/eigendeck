...
MANIFEST=(
  ...
  "text-edit-crosselement-probe.mjs|xedit.eigendeck||import_json \$ROOT/e2e/fixtures/text-edit-two-deck.json"   # text edit survives double-clicking STRAIGHT into another text box (defer commit off the gesture)
